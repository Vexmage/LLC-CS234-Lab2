...
namespace MMABooksTests
{
    ...
    public class StateTests
    {
		...
		public void TestSettersInvalidValueTryCatch()
		{
            ...
            {
                state.StateCode = "123";
                Assert.Fail("If exception is NOT thrown, the property is NOT doing the right thing");
            }
            catch (ArgumentOutOfRangeException e)
            {
				Assert.Pass("If exception is thrown, the property is doing the right thing");
			}
		}
